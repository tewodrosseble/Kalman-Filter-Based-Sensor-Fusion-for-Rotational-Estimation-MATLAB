...
% Sensor Fusion GUI with Recording, Start/Stop, Slider, and Noise Toggle
function sensor_fusion_gui_recordable
    %% Parameters
    fs = 100;
    T = 10;
    t = 0:1/fs:T;
    ...
    %% GUI & Figure Setup
    f = figure('Name', 'Sensor Fusion GUI with Recording', 'Position', [100 100 1100 550]);
